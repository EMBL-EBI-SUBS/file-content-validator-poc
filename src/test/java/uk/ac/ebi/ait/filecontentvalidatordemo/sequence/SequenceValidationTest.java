 ...
 */
package uk.ac.ebi.ait.filecontentvalidatordemo.sequence;
...
public class SequenceValidationTest {
  ...
  private static final File VALID_DIR = getResourceDir("sequence");
...
//            .field("STUDY", "test")
  ...
  private static final FileContextValidatorExecutorBuilder<SequenceManifest, ValidationResponse> executorBuilder =
      new FileContextValidatorExecutorBuilder(SequenceManifest.class, FileContextValidatorExecutorBuilder.MetadataProcessorType.MOCK)
  ...
  public void testValidTab() {
    ...
    for (File file : files) {
      ...
      FileContentValidatorExecutor<SequenceManifest, ValidationResponse> executor = executorBuilder.build(manifestFile, VALID_DIR);
