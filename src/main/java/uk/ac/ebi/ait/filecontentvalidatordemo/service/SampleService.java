 ...
 */
package uk.ac.ebi.ait.filecontentvalidatordemo.service;
...
import uk.ac.ebi.ait.filecontentvalidatordemo.service.handler.NotFoundErrorHandler;
import uk.ac.ebi.ait.filecontentvalidatordemo.service.utils.HttpHeaderBuilder;
...
{
    protected SampleService(AbstractBuilder<SampleService> builder )
    {
        super( builder );
    }
